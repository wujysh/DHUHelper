...
public class MonitorScreen extends WindowActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.monitor_confirm_course_info:
			...
			// TODO:
			bindService(new Intent("com.wujy.dhuhelper.monitor.IMonitorService"), connection, BIND_AUTO_CREATE);
			try {
				String response = monitorService.getNews(0);
				Log.d("MonitorService", "String received: " + response);
