...
//			 }
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mWebView.getSettings().setDefaultZoom(ZoomDensity.MEDIUM);// 屏幕自适应网页,如果没有这个，在低分辨率的手机上显示可能会异常
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(final String url, String userAgent,
				...
				mAlertDialog = Util.createAlertDialog(WebViewScreen.this,
						...
						"此通知为Office文档格式，下载后将使用Kingsoft Office打开，\n请安装办公软件，否则无法打开。",
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
                                ...
                                try {
                                    ...
                                    intent2.setData(uri);
                                    try {
                                        startActivity(intent2);//英文版
                                    } catch (Exception e2) {
                                        Toast.makeText(mContext, "很抱歉，因未安装办公软件，无法打开文档", Toast.LENGTH_LONG).show();

                                        Uri uri3 = Uri.parse("http://mo.wps.cn/office-for-android/index.html");
